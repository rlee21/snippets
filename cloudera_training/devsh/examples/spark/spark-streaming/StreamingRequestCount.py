# Run locally with 2 threads:  
# spark-submit --master local[2] StreamingRequestCount localhost 1234
# test using the streamtest.py script
# e.g. python $DEV2/examples/spark-streaming/streamtest.py localhost 1234 50 $DEV2DATA/static_data/weblogs/*
