...
// for example: python ~/training_materials/devsh/examples/spark/spark-streaming/streamtest.py localhost 1234 50 /home/training/training_materials/data/weblogs/*
